...
<template>
  <div id="overlay" v-if="showPopup" class="fixed inset-0 z-20 flex items-center justify-center bg-black/80"
    @click="handleOverlayClick">
    <div class="flex w-[90%] max-w-md flex-col rounded-lg bg-white pt-5 pb-7 shadow-lg dark:bg-[#000d19]">
      <div class="flex items-center px-5">
        <span class="material-symbols-outlined text-[#999999]" @click="closePopup">arrow_back_ios</span>
