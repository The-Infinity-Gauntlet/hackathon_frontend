...
<template>
    <div class="relative h-full w-full">
        ...
        <div
            v-if="!loaded && !timedOut"
            class="absolute inset-0 grid place-items-center bg-black/20"
        >
            <div
                class="flex items-center gap-2 rounded-md bg-slate-900/70 px-3 py-2 text-xs text-white"
            >
                <svg
        ...
        <div v-if="timedOut" class="absolute inset-0 grid place-items-center bg-black/30">
            <div class="w-72 rounded-lg bg-white p-4 text-center shadow dark:bg-slate-800">
                ...
                <p class="mb-3 text-xs text-slate-600 dark:text-slate-300">
                    O provedor pode bloquear iframes ou estar lento. Abra em nova aba ou tente
                    novamente.
                </p>
