...
<template>
    <div class="grid gap-8 px-5 sm:px-10 md:px-15 lg:px-20 xl:px-25">
        ...
        <section class="my-7 grid gap-5">
            ...
            />
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit, corporis! Mollitia
                pariatur, ducimus voluptate tempora provident, corporis maiores veritatis quidem
                illo excepturi officia beatae suscipit nulla assumenda consequatur debitis incidunt.
            </p>
        </section>
