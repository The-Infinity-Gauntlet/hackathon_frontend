...
<template>
  ...
  >
    <div
      class="border-r border-[#E5E5E5] px-5 text-center lg:rounded-2xl lg:border lg:border-transparent lg:bg-[#7AA6C8]/30 lg:p-5 lg:shadow-xl lg:backdrop-blur-xs dark:border-[#00182F]"
    >
